...
public class AlbumTest {
	...
	public void testConstrutorInvalido() {
		...
		try {
			...
			assertEquals(
					"Ano de lancamento do album nao pode inferior a 1900.",
					e.getMessage());
	...
	public void testAddMusicaInvalida() {
		...
		try {
			...
			try {
				...
				fail(); // se chegar aqui da erro, pois deveria lancar
						// exception.
	...
	public void testVerificaMusica() {
		...
		try {
			...
			fail(); // nao deve falhar pois e relacionada a construcao que ja
					// foi testada
		}
	...
	public void testVerificaMusicaInvalida() {
		...
		try {
			...
			try {
				...
				assertFalse(album.verificaMusica(null));
	...
	public void testGetMusicaInvalida() {
		...
		try {
			...
			try {
				...
				assertEquals(
						"Faixa da musica nao pode ultrapassar o numero limite do album",
						e.getMessage());
			}
			...
			try {
				...
				assertEquals("Faixa da musica nao pode ser negativa",
						e.getMessage());
